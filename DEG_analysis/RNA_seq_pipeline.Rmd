...
View(test) #these are missing time_point3 part_ID_x but have data for the design categories
#so confused why they're still being removed
#Desin splits time point into factors and they don't have said factors? or could be ID issue
#Model design matrix
design <- model.matrix(~time_point3 + diagnosis + age_at_do + sex + vaccine + sequence_pool, data = data$meta_data) #514 samples NA issue check
