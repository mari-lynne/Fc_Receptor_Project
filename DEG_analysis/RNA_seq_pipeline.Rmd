...
#Use contrasts_2_lm function to model all designed comparisons between control/baseline and output toptable results

results <- contrast_2_lm(group = c("V7", "V1", "D0"), control = c("V0"),efit=fit, des_mat = design, topTab="TRUE")
