...
write.table(pheno_express, file = "~/GWAS_22/Fc_receptor/data/pheno_express2_T1T2.txt", row.names = F, quote = F, sep = "\t")

table <- fread("~/GWAS_22/Fc_receptor/data/pheno_express2_T1T2.txt")
